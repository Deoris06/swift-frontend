...
const Links = ({ token, links, totalLinks, linksLimit, linkSkip }) => {
    ...
    const listOfLinks = () =>
        allLinks.map((l, i) => (
            <div key={i} className="row alert alert-light p-2">
                ...
                <div className="col-md-4 pt-2">
                    <span className="pull-right fs-6 fw-light">
                ...
                <div className="col-md-12">
                    ...
                    <span onClick={e => confirmDelete(e, l._id)} className="badge bg-danger pull-right me-3">
                        Delete
                    </span>
                    <Link href={`/user/link/${l._id}`}>
                        <a className='me-3'>
                            <span className="badge bg-primary pull-right">Update</span>
                        </a>
                    </Link>
                </div>
            </div>
    ...
    return (
        <Layout>
            <div className='container pt-5'>
                ...
                >
                    <div className="row">
                        <div className="col-md-6 offset-md-3">{listOfLinks()}</div>
                    </div>
                </InfiniteScroll>
            </div>
        </Layout>
